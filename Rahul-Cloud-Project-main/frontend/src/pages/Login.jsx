    ...
    <main className="min-h-dvh grid place-items-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-4 text-center text-[13px] text-ink-500 dark:text-ink-400">
          ...
          <Link
            to="/register"
            className="font-medium text-ink-800 dark:text-ink-200 hover:underline"
          >
            Create one
          </Link>
        </p>
        ...
        <p className="mt-3 text-center text-[11px] text-ink-400">
          Demo login — <span className="font-mono">admin@userhub.dev</span> /{" "}
          <span className="font-mono">userhub-demo</span>
        </p>
      </div>
    </main>
  );
