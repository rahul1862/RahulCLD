      ...
      <Icon
        ...
        className={
          active
            ...
            : "text-ink-300 dark:text-ink-700 group-hover:text-ink-500 transition-colors"
        }
      />
    </button>
  );
              ...
              {loading ? (
                  ...
                  <td colSpan={5}>
                    {search ? (
                      ...
                      <EmptyState
                        ...
                        action={
                          <Link to="/add" className="btn-primary btn-sm">
                            Add person
                          </Link>
                        }
                      />
                ...
                paged.map((u) => (
                  <tr key={u._id}>
                    ...
                    <td className="hidden lg:table-cell text-[12px] text-ink-500 dark:text-ink-500 truncate max-w-[160px]">
                      {u.company}
                    </td>
                    <td>
                  ...
                  <span key={p} className="flex items-center">
                    ...
                    <button
                      ...
                      className={`w-7 h-7 rounded text-[12px] font-medium transition-colors
                        ${p === page ? "bg-ink-900 dark:bg-ink-100 text-white dark:text-ink-900" : "text-ink-500 hover:bg-ink-100 dark:hover:bg-ink-800"}`}
                    >
                      {p}
                    </button>
                  </span>
