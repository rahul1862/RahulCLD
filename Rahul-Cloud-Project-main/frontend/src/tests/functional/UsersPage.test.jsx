...
const USERS = [
  { _id: "1", name: "Alice Smith", email: "alice@example.com", address: "1 Main St", createdAt: "2026-01-01T00:00:00.000Z" },
  { _id: "2", name: "Bob Jones", email: "bob@example.com", address: "2 Side St", createdAt: "2026-01-02T00:00:00.000Z" },
];
...
describe("UsersPage (manage people feature)", () => {
  beforeEach(() => {
    ...
    userService.remove.mockReset().mockResolvedValue({ message: "Deleted" });
  });
  ...
  test("search narrows the list down to matching people", async () => {
    ...
    fireEvent.change(screen.getByLabelText(/search people/i), { target: { value: "bob" } });
